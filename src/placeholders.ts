...
export const PLACEHOLDER_DASHBOARD_STATS: Array<{
  ...
  cls: string;
    ...
    { label: 'MAYDAY Balance', value: '—', cls: 'green' },  // GET /api/me       → lp_balance
  ];
...
export const PLACEHOLDER_PROJECTS: Project[] = [
  ...
  {
    id: 'placeholder-1',
    name: 'Flight Computer Rig',
    description: 'A placeholder hardware mission for a custom flight computer, sensor stack, and launch-day telemetry enclosure.',
