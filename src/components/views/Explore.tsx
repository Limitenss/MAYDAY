    ...
    <div className="view-content">
      <div className="view-header-row">
        <div className="view-header" style={{ margin: 0 }}>
          <span className="section-code">Mission Directory: All Builds</span>
          <p>Look at what others have built!</p>
        </div>
      ...
      <div className="compact-grid">
        {filtered.map((build, i) => (
          <div key={i} className="compact-card" role="article">
            {build.name === "placeholder-build" ? (
              <>
                <div className="card-header">
                  <div
                    className="skeleton"
                    style={{ width: 74, height: 18, borderRadius: 0 }}
                  />
                  <div
                    className="skeleton"
                    style={{ width: 52, height: 14, borderRadius: 0 }}
                  />
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  <div
                    className="skeleton"
                    style={{ width: "62%", height: "1rem", borderRadius: 0 }}
                  />
                  <div
                    className="skeleton"
                    style={{ width: "34%", height: "0.7rem", borderRadius: 0 }}
                  />
                </div>
                ...
                >
                  ...
                  <div
                    className="skeleton"
                    style={{ width: "56%", height: "0.8rem", borderRadius: 0 }}
                  />
                </div>
                ...
                <div style={{ display: "flex", gap: "6px" }}>
                  <div
                    className="skeleton"
                    style={{ flex: 1, height: 32, borderRadius: 0 }}
                  />
                  <div
                    className="skeleton"
                    style={{ width: 38, height: 32, borderRadius: 0 }}
                  />
                </div>
              </>
            ) : (
