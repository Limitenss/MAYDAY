    ...
    <div className="view-content">
      <div className="view-header-row">
        <div className="view-header" style={{ margin: 0 }}>
          <span className="section-code">Mission Loadout</span>
          <p>Redeem MAYDAY Points for hardware and other things..</p>
        </div>
          ...
          <div key={i} className="compact-card" style={{ gap: "1rem" }}>
            ...
            >
              ...
              >
                <div
                  className="skeleton"
                  style={{ width: "40%", height: "0.6rem", borderRadius: 0 }}
                />
                <div
                  className="skeleton"
                  style={{ width: "70%", height: "0.85rem", borderRadius: 0 }}
                />
              </div>
            </div>
            ...
            >
              <div
                className="skeleton"
                style={{ width: "100%", height: "0.7rem", borderRadius: 0 }}
              />
              <div
                className="skeleton"
                style={{ width: "80%", height: "0.7rem", borderRadius: 0 }}
              />
            </div>
            ...
            >
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                ...
                <div
                  className="skeleton"
                  style={{ width: 48, height: "0.65rem", borderRadius: 0 }}
                />
              </div>
              <div
                className="skeleton"
                style={{ width: 80, height: 32, borderRadius: 0 }}
              />
            </div>
          </div>
        ))}
