        ...
        <div className="gc-landing-grid">
          ...
          >
            <div className="gc-module">
              ...
              <p className="landing-tagline">
                Build something real. Deploy it. Earn MAYDAY Points and redeem
                them for hardware.{" "}
                <button
                  type="button"
                  className="landing-tagline-link"
              ...
              <div className="landing-stats">
                <div className="landing-stat">
                  ...
                  <div className="stat-value">
                    {PLACEHOLDER_GLOBAL_STATS.missionsFiled}
                  </div>
                ...
                <div className="landing-stat">
                  ...
                  <div
                    className={`stat-value${PLACEHOLDER_GLOBAL_STATS.submissionWindow === "OPEN" ? " stat-open" : ""}`}
                  >
                ...
                <div className="landing-stat">
                  ...
                  <div className="stat-value">
                    {PLACEHOLDER_GLOBAL_STATS.participantCount}
                  </div>
          ...
          >
            ...
            <p className="auth-description">
              Sign in with your Hack Club account to join the fleet and start
